...
class HorizontalButtonList @JvmOverloads constructor(
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.horizontal_button_list_layout, this, true)
        button = findViewById(R.id.customButton)

        headerTextView = findViewById(R.id.horizontal_button_list_header)
    ...
    private fun setAdapter(items: List<ListItemModel>){
        ...
        val recyclerView: RecyclerView = findViewById(R.id.horizontal_button_list_recyclerview)
